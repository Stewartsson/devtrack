...
export default function AuthSecurityManager() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-6 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-zinc-900 shadow-sm space-y-6 text-gray-900 dark:text-gray-100">
      <div className="flex items-center gap-3 border-b border-gray-100 dark:border-gray-800 pb-4">
        <div className="p-2 rounded-xl bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400">
          🛡️
        </div>
        <div>
          <h2 className="text-xl font-bold">Advanced Account Security Manager</h2>
      ...
      <div className="border-t border-gray-100 dark:border-gray-800 pt-5 space-y-4">
        ...
        {mfaStatus === 'disabled' && (
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 border border-dashed border-gray-200 dark:border-gray-800 rounded-xl bg-gray-50/50 dark:bg-zinc-950/20">
            <div>
              <h4 className="text-sm font-bold">MFA is currently inactive</h4>
            ...
            <button
              ...
              disabled={loading !== null}
              className="px-4 py-2 text-xs font-bold text-white bg-blue-600 hover:bg-blue-500 rounded-xl shadow-sm self-start sm:self-center shrink-0 transition-all "
            >
              Setup TOTP Factor
            </button>
          </div>
          ...
          <div className="p-4 border border-blue-100 dark:border-blue-900/50 rounded-xl bg-blue-50/20 dark:bg-blue-950/10 space-y-4">
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              ...
              <div className="space-y-1 text-center sm:text-left">
                <h4 className="text-sm font-bold">Scan Authenticator Configuration Code</h4>
            ...
            <form onSubmit={handleVerifyMFA} className="flex gap-2 border-t border-blue-100 dark:border-blue-900/30 pt-3">
              <input
                ...
                className="flex-1 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-gray-800 px-3 py-2 rounded-xl text-center font-mono text-sm tracking-widest focus:outline-none focus:border-blue-500"
              />
              <button
                type="submit"
                disabled={loading !== null || verificationCode.length !== 6}
                className="px-4 py-2 text-xs font-bold text-white bg-blue-600 hover:bg-blue-500 rounded-xl shadow-sm transition-all"
              >
                Verify & Activate
              </button>
            </form>
        ...
        {mfaStatus === 'verified' && (
          <div className="flex items-center gap-3 p-4 border border-emerald-200 dark:border-emerald-900/50 rounded-xl bg-emerald-50/20 dark:bg-emerald-950/10 text-emerald-800 dark:text-emerald-400">
            🟢
            <div>
              <h4 className="text-sm font-bold">Multi-Factor Authentication Secured</h4>
